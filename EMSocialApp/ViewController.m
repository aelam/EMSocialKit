...
- (IBAction)share {
    ...
    EMActivityViewController *activityViewController = [[EMActivityViewController alloc] initWithActivityItems:@[@"test",@"http://baidu.com"/*,[NSURL URLWithString:@"http://baidu.com"]*/] applicationActivities:activies];
